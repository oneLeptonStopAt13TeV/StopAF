...
bool SR1l_B_250lessMETless450() { return (SR1l() && myEvent.ngoodjets<=3 && myEvent.topnessMod>=10 && myEvent.Mlb>175 && myEvent.dphi_ak4pfjets_met>=0.8 && tightCSVV2() && myEvent.pfmet>=250 && myEvent.pfmet<450);}
bool SR1l_B_450lessMETless600() { return (SR1l() && myEvent.ngoodjets<=3 && myEvent.topnessMod>=10 && myEvent.Mlb>175 && myEvent.dphi_ak4pfjets_met>=0.8 && tightCSVV2() && myEvent.pfmet>=450 && myEvent.pfmet<600);}
bool SR1l_B_600lessMETlessInf() { return (SR1l() && myEvent.ngoodjets<=3 && myEvent.topnessMod>=10 && myEvent.Mlb>175 && myEvent.dphi_ak4pfjets_met>=0.8 && tightCSVV2() && myEvent.pfmet>=600);}
...
bool SR1l_D_250lessMETless350() { return (SR1l() && myEvent.ngoodjets>=4 && myEvent.topnessMod<=0 && myEvent.Mlb>175 && myEvent.dphi_ak4pfjets_met>=0.8 && tightCSVV2() && myEvent.pfmet>=250 && myEvent.pfmet<350);}
bool SR1l_D_350lessMETless450() { return (SR1l() && myEvent.ngoodjets>=4 && myEvent.topnessMod<=0 && myEvent.Mlb>175 && myEvent.dphi_ak4pfjets_met>=0.8 && tightCSVV2() && myEvent.pfmet>=350 && myEvent.pfmet<450);}
bool SR1l_D_450lessMETless550() { return (SR1l() && myEvent.ngoodjets>=4 && myEvent.topnessMod<=0 && myEvent.Mlb>175 && myEvent.dphi_ak4pfjets_met>=0.8 && tightCSVV2() && myEvent.pfmet>=450 && myEvent.pfmet<550);}
bool SR1l_D_550lessMETlessInf() { return (SR1l() && myEvent.ngoodjets>=4 && myEvent.topnessMod<=0 && myEvent.Mlb>175 && myEvent.dphi_ak4pfjets_met>=0.8 && tightCSVV2() && myEvent.pfmet>=550);}
...
bool SR1l_F_250lessMETless450() { return (SR1l() && myEvent.ngoodjets>=4 && myEvent.topnessMod>0  && myEvent.topnessMod<=10 && myEvent.Mlb>175 && myEvent.dphi_ak4pfjets_met>=0.8 && tightCSVV2() && myEvent.pfmet>=250 && myEvent.pfmet<450);}
bool SR1l_F_450lessMETlessInf() { return (SR1l() && myEvent.ngoodjets>=4 && myEvent.topnessMod>0  && myEvent.topnessMod<=10 && myEvent.Mlb>175 && myEvent.dphi_ak4pfjets_met>=0.8 && tightCSVV2() && myEvent.pfmet>=450);}
