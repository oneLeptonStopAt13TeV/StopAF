...
void BabyScrewdriver::ActionForEachEvent(string currentDataset)
{
    ...
    if (currentProcessType == "signal" && ( (myEvent.gen_stop_m.at(0) == 425 && myEvent.gen_neutralino_m.at(0) ==300) || (myEvent.gen_stop_m.at(0) == 650 && myEvent.gen_neutralino_m.at(0) ==350) ||( myEvent.gen_stop_m.at(0) == 900 && myEvent.gen_neutralino_m.at(0) == 50) ))
    {
