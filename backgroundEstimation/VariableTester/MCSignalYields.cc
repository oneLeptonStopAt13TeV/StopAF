...
void BabyScrewdriver::Init()
{
    ...
    AddVariable("StopMass","stop mass", "GeV",200,200,1200, &mStop);
    AddVariable("NeutralinoMass","lsp mass", "GeV",200,0,1000, &mNeutralino);
...
void BabyScrewdriver::PostProcessingStep()
{
   ...
   */ 
    ...
    TableDataMC(this, signalReg,"lepChannel" ).Print("yield.tab", 4);
    /*
    TableDataMC(this, totYield,"lepChannel" ).Print("yield.tab", 4);
