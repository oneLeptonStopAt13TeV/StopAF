...
#------------------------------------------------------------------------------
compile: ../../common/libVectorDictionnary_C.so $(TARGET).$(ExeSuf)
...
../../common/libVectorDictionnary_C.so: ../../common/vectorDictionnary.C
	cd ../../common/; g++ -o libVectorDictionnary_C.so -shared -fPIC vectorDictionnary.C `root-config --cflags`

%.$(ExeSuf): %.$(SrcSuf) ../../common/libVectorDictionnary_C.so
