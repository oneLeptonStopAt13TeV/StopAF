...
bool CR0b_presel_MTpeak() { return CR0b_presel() && (myEvent.mt_met_lep < 80) ; }
bool CR0b_presel_MTtail() { return CR0b_presel() && (myEvent.mt_met_lep > 100) ; }

bool CR0b_presel_2j_MTpeak() { return CR0b_presel_nojetreq() && myEvent.ngoodjets == 2 && (myEvent.mt_met_lep < 80) ; }
bool CR0b_presel_2j_MTtail() { return CR0b_presel_nojetreq() && myEvent.ngoodjets == 2 && (myEvent.mt_met_lep > 100) ; }
bool CR0b_presel_3j_MTpeak() { return CR0b_presel_nojetreq() && myEvent.ngoodjets == 3 && (myEvent.mt_met_lep < 80) ; }
...
void BabyScrewdriver::Init()
{
    ...
    */
    ...
    AddRegion("CR0b_presel_MTtail", "CR - == 0b - >=4j - MTpeak", &CR0b_presel_MTtail);
    AddRegion("CR0b_presel_2j_MTpeak", "CR - == 0b - >=4j - MTpeak", &CR0b_presel_MTpeak);
    AddRegion("CR0b_presel_2j_MTtail", "CR - == 0b - >=4j - MTpeak", &CR0b_presel_MTtail);
    AddRegion("CR0b_presel_3j_MTpeak", "CR - == 0b - >=4j - MTpeak", &CR0b_presel_MTpeak);
    AddRegion("CR0b_presel_3j_MTtail", "CR - == 0b - >=4j - MTpeak", &CR0b_presel_MTtail);
